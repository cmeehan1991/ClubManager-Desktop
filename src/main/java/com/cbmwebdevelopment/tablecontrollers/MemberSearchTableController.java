 ...
 * @author cmeehan
 */
public class MemberSearchTableController {
    public void tableController(TableView tableView){
        TableColumn<MemberSearch, Integer> idColumn = new TableColumn<>("ID");
        TableColumn<MemberSearch, String> nameColumn = new TableColumn<>("First & Last Name");
        TableColumn<MemberSearch, Integer> membershipIdColumn = new TableColumn<>("Membership ID");
    ...
    public static class MemberSearch{
        ...
        public MemberSearch(Integer id, String name, Integer membershipId){
